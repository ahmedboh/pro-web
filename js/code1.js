...
con1.drawImage(video,-450,-150);
con1.fillStyle="rgba(0, 0, 230,0.8)";
con1.beginPath();
con1.moveTo(0,0);
con1.lineTo(50,0);
con1.lineTo(0,50);
...
if(!isNaN(video.duration)) {
// Dessin de la vidéo dans les deux contextes
con2.fillStyle="rgba(0, 0, 230,0.8)";
con2.drawImage(video,-450,-150);
con2.beginPath();
con2.moveTo(0,0);
con2.lineTo(50,0);
con2.lineTo(0,50);
...
if(!isNaN(video.duration)) {
// Dessin de la vidéo dans les deux contextes
con3.fillStyle="rgba(0, 0, 230,0.8)";
con3.drawImage(video,-450,-150);
con3.beginPath();
con3.moveTo(0,0);
con3.lineTo(50,0);
con3.lineTo(0,50);
